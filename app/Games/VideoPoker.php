...
class VideoPoker extends ExtendedGame implements MultiplierCanBeLimited {
    ...
    private function getMultiplier(Game $game, ?array $turnData, bool $replace, string $server_seed) {
        ...
        $isFlush = array_count_values($userTypes) == 1;
        ...
        if(in_array('A', $userValues) && in_array('K', $userValues) && in_array('Q', $userValues) && in_array('J', $userValues) && in_array('10', $userValues)) return HouseEdgeModule::apply($this, 600);
