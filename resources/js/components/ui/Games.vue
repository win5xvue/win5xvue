        ...
        <template v-for="(category, key) in categories">
            ...
            <div class="games">
                <div v-for="game in category" :key="game.id" :class="`game_poster game-${game.id} game_type-local`">
                    <div :class="`game_poster-image game-${game.id}-image`" @click="game.isDisabled ? '' : $router.push(`/game/${game.id}`)">
                    ...
                    <div class="game_poster-houseEdge" v-if="game.houseEdge" @click="game.isDisabled ? '' : $router.push(`/game/${game.id}`)">
                        {{ game.houseEdge }}% House Edge
                    </div>
                    <div class="game_poster-name" @click="game.isDisabled ? '' : $router.push(`/game/${game.id}`)">
                        {{ game.name }}
                    </div>
...
<style lang="scss">
    ...
    .game-baccarat {
        &-image {
            &:after {
                background-image: url('/img/game/baccarat.svg');
            }
