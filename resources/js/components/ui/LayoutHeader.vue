        ...
        <div class="fixed">
            <div class="container-fluid">
                <div class="header-container">
                    ...
                    <div class="menu">
                        <router-link tag="div" to="/" :class="($route.path === '/' || $route.path === '/index' || $route.path.startsWith('/game')) ? 'active' : ''">{{ $t('general.head.games') }}</router-link>
                        <div @click="openFaucetModal()">{{ $t('general.head.bonus') }}</div>
                        <div @click="openTerms('faq')">{{ $t('general.head.help') }}</div>
                        <router-link tag="div" to="/fairness" :class="($route.path === '/fairness') ? 'active' : ''">{{ $t('fairness.title') }}</router-link>
                    </div>
                    ...
                    <div class="wallet" v-if="!isGuest && currencies" v-click-outside="() => expand = false">
                        ...
                        <div class="btn btn-primary wallet-open" @click="demo ? openDemoBalanceModal() : $router.push('/wallet')">{{ demo ? $t('general.head.wallet_open_demo') : $t('general.head.wallet') }}</div>
                    </div>
        ...
        .fixed {
            ...
            @include themed() {
                ...
                .logo {
                    ...
                    display: flex;
                    cursor: pointer;
                    background: url('/img/misc/header-logo.png') no-repeat center;
