            ...
            <div class="footer">
                <div class="column">
                    <div class="logo">
                        <div class="logo"></div>
                        <div class="socials">
                            <div class="social" onclick="window.open('https://www.instagram.com/betlix_io/', '_blank')"><icon icon="fab fa-instagram"></icon></div>
                            <div class="social" onclick="window.open('https://t.me/Betlix', '_blank')"><icon icon="fab fa-telegram"></icon></div>
                    ...
                    <div class="info">
                        ...
                        <a href="https://t.me/Betlix">Live-Chat</a>
                    </div>
                </div>
                <div class="column">
                    <div class="copy">
                    ...
                    <div class="w5x-team" onclick="window.open('https://playin.team', '_blank')"><img src="/img/misc/win5x_logo_white.png" alt> Betlix.io</div>
                    <a href="https://www.free-kassa.ru/" class="fk"><img src="https://www.free-kassa.ru/banner/logomail.png"></a>
                </div>
            </div>
        </div>
    </footer>
