                        ...
                        <div class="walletColumnContent">
                            ...
                            <template v-else>
                                ...
                                <div class="walletButtons">
                                    <div class="walletButton" @click="sum = 50">
                                        50
                                    </div>
                                    <div class="walletButton" @click="sum = 100">
                                        100
                                    </div>
                                    <div class="walletButton" @click="sum = 250">
                                        250
                                    </div>
                                    <div class="walletButton" @click="sum = 500">
                                        500
                                    </div>
                                    <div class="walletButton" @click="sum = 1000">
                                        1000
                                    </div>
                                    <div class="walletButton" @click="sum = 2500">
                                        2500
                                    </div>
                                    <div class="walletButton" @click="sum = 5000">
                                        5000
                                    </div>
                                    <div class="walletButton" @click="sum = 10000">
                                        10000
                                    </div>
                                </div>
                                <div class="divider">
                                ...
                                <div class="aggregators">
                                    <div :class="`aggregator ${aggregator === 'freekassa' ? 'active' : ''}`" @click="aggregator = 'freekassa'">
                                        <div class="icon">
                                            <img alt src="/img/payment/freekassa.svg">
                                        </div>
                                        <div class="name">
                                            Free-Kassa
                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-7 col-lg-8 col-xl-9">
                        <div class="walletColumnContent">
                            ...
                            <div class="mt-2">
                                <div class="mb-2">{{ $t('wallet.withdraw.enter_wallet') }}</div>
                                <input :placeholder="$t('wallet.withdraw.wallet')" v-model="wallet">
                            </div>
                            <div class="divider">
                                <div class="line"></div>
                                <i class="fal fa-angle-down"></i>
                            ...
                            <template v-if="withdraw.startsWith('local_')">
                                <div class="aggregators">
                                    <div :class="`aggregator ${localWithdrawType === 'qiwi' ? 'active' : ''}`" @click="localWithdrawType = 'qiwi'">
                                        <div class="icon">
                                            <img alt src="/img/payment/qiwi_color.png">
                                        </div>
                                        <div class="name">
                                            Qiwi
                                        </div>
                                    </div>
                                    <div :class="`aggregator ${localWithdrawType === 'payeer' ? 'active' : ''}`" @click="localWithdrawType = 'payeer'">
                                        <div class="icon">
                                            <img alt src="/img/payment/payeer.png">
                                        </div>
                                        <div class="name">
                                            Payeer
                                        </div>
                                    </div>
                                    <div :class="`aggregator ${localWithdrawType === 'megafon' ? 'active' : ''}`" @click="localWithdrawType = 'megafon'">
                                        <div class="icon">
                                            <img alt src="/img/payment/mf_color.png">
                                        </div>
                                        <div class="name">
                                            Megafon
                                        </div>
                                    </div>
                                    <div :class="`aggregator ${localWithdrawType === 'mts' ? 'active' : ''}`" @click="localWithdrawType = 'mts'">
                                        <div class="icon">
                                            <img alt src="/img/payment/mts_color.png">
                                        </div>
                                        <div class="name">
                                            MTS
                                        </div>
                                    </div>
                                    <div :class="`aggregator ${localWithdrawType === 'tele2' ? 'active' : ''}`" @click="localWithdrawType = 'tele2'">
                                        <div class="icon">
                                            <img alt src="/img/payment/tele2_color.png">
                                        </div>
                                        <div class="name">
                                            Tele2
                                        </div>
                                    </div>
                                    <div :class="`aggregator ${localWithdrawType === 'beeline' ? 'active' : ''}`" @click="localWithdrawType = 'beeline'">
                                        <div class="icon">
                                            <img alt src="/img/payment/beeline_color.png">
                                        </div>
                                        <div class="name">
                                            Beeline
                                        </div>
                            ...
                            <div class="walletOut">
                                <div>{{ $t('wallet.withdraw.amount', { min: this.rawBitcoin(withdraw, currencies[withdraw].minimalWithdraw), currency: currencies[withdraw].name }) }}</div>
                                <input type="text" v-model="sum" v-money="money">
                                <div class="mb-3" v-if="!withdraw.startsWith('local_')">{{ $t('wallet.withdraw.fee', { fee: this.rawBitcoin(withdraw, currencies[withdraw].withdrawFee), currency: currencies[withdraw].name }) }}</div>
        ...
        methods: {
            makeDeposit() {
                ...
                axios.post('/api/wallet/deposit', {
                    ...
                    win.close();
                    this.$toast.error(this.$i18n.t('general.error.invalid_deposit'));
                });
            },
            exchange() {
