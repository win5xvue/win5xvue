            ...
            <div class="glide" id="slider">
                <div class="glide__track" data-glide-el="track">
                    <ul class="glide__slides">
                        <li class="glide__slide" style="background-image: url('/img/misc/slider/main-slider.png')">
                            <div class="slideContent right">
                                <div class="slideContentWrapper">
                                    <div class="header">
                                        <div class="image" style="background-image: url('/img/misc/slider-logo.png')"></div>
                                    </div>
                                    <div class="description">
                                        {{ $t('general.slider.1') }}
                                    </div>
                                    <div class="button" @click="isGuest ? openAuthModal('auth') : openFaucetModal()">
                                        {{ $t('general.play') }}
                                    </div>
                                </div>
                            </div>
